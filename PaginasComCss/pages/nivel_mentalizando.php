                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 80px;">
                        <h2 style="margin-top: -50px; padding-bottom: 50px; font-family: 'Raleway', sans-serif;
                            ...
                            margin: 0px;
                            letter-spacing: 2px; text-align: center;">Mentalizando</h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <?php
                                    if ($_GET["jogo"] == 1) {
                                        echo "<a class='pull-left' href='../../mentalizando_frutas1.php'> Nível 2 </a></br>";
                                    }
                                    ?>
                                </span></a>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <?php
                                if ($_GET["jogo"] == 1) {
                                    echo "<a class='pull-left' href='../../mentalizando_objetos1.php'> Nível 3 </a></br>";
                                }
                                ?> 
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
