...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            $(function() {
                $('#resp11, #resp12, #resp13, #resp14, #resp15,#resp16').clicked(function() {
                    $('#resp11,#resp12, #resp13, #resp14, #resp15,#resp16').css('background', '#D94848');
                });
                $('#resp21, #resp22, #resp23, #resp24, #resp25,#resp26').clicked(function() {
                    $('#resp21, #resp22, #resp23, #resp24, #resp25,#resp26').css('background', '#D94848');
                });
                $('#resp31, #resp32, #resp33, #resp34, #resp35,#resp36').clicked(function() {
                    $('#resp31, #resp32, #resp33, #resp34,#resp35,#resp36').css('background', '#D94848');
                });
                $('#resp41, #resp42, #resp43, #resp44, #resp45,#resp46').clicked(function() {
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div>
                    ...
                    if ($result) {
                        echo "<form method='post' action='quantos_nivel2_correcao.php'>";
